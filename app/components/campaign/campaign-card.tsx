...
import { MapPin, Target, Users, Award, ExternalLink } from "lucide-react";
    ...
    <div className="group relative flex flex-col gap-6 rounded-2xl border border-white/5 bg-white/5 p-6 transition-all hover:border-indigo-500/30 hover:bg-indigo-500/5 shadow-2xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className={`font-mono text-[9px] font-bold uppercase tracking-widest ${remainingClaims > 0 ? "text-emerald-400" : "text-red-400"}`}>
