  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => claimBounty('4ysUbXcRMXJkmTx6y7ek34aDLkakG7ihpgZ4VEzXGmko')}
      >
        <Text style={styles.buttonText}>
          {status === 'claiming' ? 'INITIALIZING_MWA...' : status === 'success' ? 'CLAIMED_SUCCESS' : inRange ? 'CLAIM_DROP' : 'OUT_OF_RANGE'}
        </Text>
      </TouchableOpacity>
